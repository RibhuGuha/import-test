...
@Table(name = "\"FrontendApp\"", schema =  "\"ExclusiveAccess\"")
@Data
...
@Column(name = "\"MetaTags\"")
    ...
    @CollectionTable(schema = "\"ExclusiveAccess\"", name = "\"FrontendAppMetaTags\"",joinColumns = @JoinColumn(name = "\"AppId\""))
...
@Column(name = "\"SelectedScreenIds\"")
    @ElementCollection(fetch = FetchType.LAZY)
    @CollectionTable(schema = "\"ExclusiveAccess\"", name = "\"FrontendAppSelectedScreenIds\"",joinColumns = @JoinColumn(name = "\"AppId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"FeScreenId\""), schema = "\"ExclusiveAccess\"")
