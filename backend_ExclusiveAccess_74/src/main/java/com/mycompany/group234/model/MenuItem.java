...
@Table(name = "\"MenuItem\"", schema =  "\"ExclusiveAccess\"")
@Data
...
public class MenuItem {
  ...
  private Integer sequenceNumber;
	...
	@OneToOne(cascade = CascadeType.ALL)
	@JoinColumn(name = "\"MenuItemFrontendScreen\"", referencedColumnName = "\"FeScreenId\"", insertable = false, updatable = false)
	private FrontendScreen frontendScreen;
	
	@Column(name = "\"MenuItemFrontendScreen\"")
	private Integer menuItemFrontendScreen;
